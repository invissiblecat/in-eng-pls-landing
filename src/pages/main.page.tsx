...
const educationProps: SectionProps = {
  ...
  text: (
    <>
      ТвГУ факультет иностранных языков и международной коммуникации&nbsp;по&nbsp;направлению
      «теория&nbsp;и&nbsp;методика преподавания»&nbsp;- бакалавр. <br /> <br /> ТвГУ факультет
      иностранных языков и международной&nbsp;коммуникации&nbsp;по&nbsp;направлению
      «управление&nbsp;международными проектами» - магистр. <br />
